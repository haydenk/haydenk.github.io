+++
title = 'Two Primaries, One Ballot: How the 2026 Texas Republican and Democratic Races Compare'
slug = 'two-primaries-one-ballot-comparing-2026-texas-republican-democratic-races'
date = 2026-02-12 13:17:10
draft = false
tags = ['texas', 'politics', 'elections', '2026-primary', 'republican', 'democrat', 'voter-guide', 'dallas-county', 'analysis']
+++
...
1. **Ken Paxton** (US Senate) — Impeached, securities fraud indictment, whistleblower retaliation, consultant indicted
2. **Sid Miller** (Ag Commissioner) — Texas Rangers investigation, ethics fines, consultant bribery, alleged marijuana disposal
3. **Greg Abbott** (Governor) — Winter Storm Uri grid failures, migrant busing controversies

### Democratic Controversy Top 3
1. **Amber Givens** (DA challenger) — Sanctioned twice by judicial conduct commission, Texas Rangers investigation, wrongful imprisonment lawsuit, pay withheld
2. **Jasmine Crockett** (US Senate) — Crypto/corporate PAC donors vs. progressive branding, no ads despite $6.5M raised
3. **James Talarico** (US Senate) — Unverified "mediocre Black man" allegation
